...
const blockUser = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    res.json({ msg: 'User Blocked', blockusr })
  } catch (error) {
    throw new Error(error)
  }
})
...
const forgotPasswordToken = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    const resetURL = `
    Hola, siga este enlace para restablecer su contraseña. Este enlace es válido hasta dentro de 10 minutos a partir de ahora. <a href='http://localhost:5000/api/user/reset-password/${token}'>Click Here</>`
